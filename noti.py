...
def notifyPushover(movie):
    if config.get("pushover_app_token") is not None or config.get("pushover_app_token")=="":
...
def notifyOpenHAB(movie):
    if config.get("openhab_ip") is not None or config.get("openhab_ip")=="" and config.get("openhab_port") is not None or config.get("openhab_port")=="":
...
def notifyPushbullet(movie):
    if config.get("pushbullet_api_key") is not None or config.get("pushbullet_api_key")=="":
